...
public class DSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case DSLPackage.MEASUREMENT_ACTION:
      {
        ...
        T result = caseMeasurementAction(measurementAction);
        if (result == null) result = caseActions(measurementAction);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Measurement Action</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseMeasurementAction(MeasurementAction object)
  {
    return null;
  }
